...
<body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navigation-example-2">
          <ul class="nav navbar-nav navbar-right">
            <li>
                <a href="{{ url('/dashboard') }}" class="btn btn-simple">Dashboard</a>
            </li>
    ...
    <div class="alert alert-danger landing-alert">
         <div class="container text-center">
             <h5>You're in the restricted section now.</h5>
        </div>
    </div>
    ...
    <div class="wrapper">
        ...
        style="background-image: url('{{ url('assets/img/bg-3.jpg') }}');">
                ...
                <div class="container">
                    ...
                    <div class="col-md-4">
                        <div class="team-player">
                            <img src="{{ url('assets/paper_img/chet_faker_2.jpg') }}" alt="Thumbnail Image" class="img-circle img-responsive">
                    ...
                    <div class="col-md-4">
                        <div class="team-player">
                            <img src="{{ url('assets/paper_img/flume.jpg') }}" alt="Thumbnail Image" class="img-circle img-responsive">
                    ...
                    <div class="col-md-4">
                        <div class="team-player">
                            <img src="{{ url('assets/paper_img/banks.jpg') }}" alt="Thumbnail Image" class="img-circle img-circle img-responsive">
